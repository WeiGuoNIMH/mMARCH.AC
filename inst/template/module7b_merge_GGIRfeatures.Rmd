...
outFN.anno<-paste("module7_",studyname,"_all_features_dictionary.xlsx",sep="") 
...
part2<-dict[which(dict[,"Source"]=="GGIR-part2"),"Variable"] #9/1 IV and IS
part4<-dict[which(dict[,"Source"]=="GGIR-part4"),"Variable"]
part6<-dict[which(dict[,"Source"]=="GGIR-part5"),"Variable"]
partR<-dict[which(dict[,"Source"]=="mMARCH.AC"),"Variable"]
